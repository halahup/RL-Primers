...
NUM_EPOCHS = 5000
NUM_STEPS = 500              # number of steps to bootstrap after
...
def main():
    ...
    # policy network
    actor = Actor(observation_space_size=8, action_space_size=4, hidden_size=HIDDEN_SIZE)

    # state-value network
    critic = Critic(observation_space_size=8, hidden_size=HIDDEN_SIZE)
